			 ...
			 bool varonleft, bool negate)
{
										   ...
										   (opfuncoid = get_opcode(oproid))))
	{
							 ...
							 ATTSTATSSLOT_VALUES | ATTSTATSSLOT_NUMBERS))
		{
			 ...
			 * scanning the remaining MCVs and accumulate the selectivity
			 * of all matching MCVs.
			 *
			 * While scanning, also accumulate the selectivity of the
			 * MCVs examined so far. This is used later to estimate the
			 * selectivity of a non-NULL constant that does not match
			 * any MCV.
			 */
			selec = 0.0;
