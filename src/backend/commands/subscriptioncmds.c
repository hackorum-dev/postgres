...
AlterSubscription_refresh_table(Subscription *sub, List *relations)
{
	 ...
	 *
	 * The relations are locked here at the level the truncate below needs,
	 * rather than being locked weakly now and upgraded later.
	 */
	foreach(lc, relations)
	{
		...
		relid = RangeVarGetRelid(rv, lockmode, false);
	 ...
	 */
	CheckRefreshTableNotShared(rel, sub, subrelids, relids);
