...
#define CHKATYPE_ANYARRAY		(1 << 0)	/* allow ANYARRAY */
#define CHKATYPE_ANYRECORD		(1 << 1)	/* allow RECORD and RECORD[] */
#define CHKATYPE_IS_PARTKEY		(1 << 2)	/* attname is part key # not column */
