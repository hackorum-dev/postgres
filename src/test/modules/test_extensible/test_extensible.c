					  ...
					  Index rti, RangeTblEntry *rte)
{
	 ...
	 * actually scan. The relkind test matters: table_slot_callbacks() and
	 * table_beginscan() require a relation with a table AM, which rules out
	 * foreign tables, partitioned tables and the like. TABLESAMPLE is
	 * excluded too, as we would otherwise override the sample scan and return
	 * the whole relation.
	 */
