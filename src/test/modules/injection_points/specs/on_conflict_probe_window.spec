...
step nothing1 { INSERT INTO probe_a VALUES (1, 99) ON CONFLICT (key) DO NOTHING; }
step select1 { INSERT INTO probe_a VALUES (1, 99) ON CONFLICT (key) DO SELECT RETURNING val; }
step select1_keyshare { INSERT INTO probe_a VALUES (1, 99) ON CONFLICT (key) DO SELECT FOR KEY SHARE RETURNING val; }
...
permutation nothing1 count2 update2 c2 wake2 insert1 c1
permutation select1 count2 update2 c2 wake2 insert1 c1
permutation select1_keyshare count2 update2 c2 wake2 insert1 c1
