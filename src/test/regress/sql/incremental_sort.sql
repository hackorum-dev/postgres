...
-- Parallel sort below join.  The lateral side reaches nothing in the output, so
-- eager deduplication would fold it into an existence check and this would stop
