...
CREATE TABLE gtest_check_parent (a int, b int GENERATED ALWAYS AS (a * 2) STORED
...
CREATE TABLE gtest_check (a int, b int GENERATED ALWAYS AS (a * 2) STORED);
...
CREATE TABLE gtest_nn_invalid (a int, b int GENERATED ALWAYS AS (a) STORED);
