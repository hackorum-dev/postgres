...
# max_wal_size is set to the larger value to prevent other checkpoints from
# occurring
...
# Start a psql session to run the checkpoint in the background. It cannot
# complete while the walsender is stopped.
