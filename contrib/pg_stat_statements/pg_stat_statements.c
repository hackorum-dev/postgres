...
typedef struct pgssEntry
{
	...
	TimestampTz stats_last_updated; /* timestamp of last stats update (statement end) */
		   ...
		   PlannedStmtOrigin planOrigin)
{
	...
	if (!jstate)
	{
		...
		/* Update the timestamp of the last stats update */
		entry->stats_last_updated = stats_updated_at;
