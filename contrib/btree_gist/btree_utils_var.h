...
typedef struct
{
	...
	bool		(*f_gt) (const void *, const void *, fmLocalePtr, FmgrInfo *);	/* greater than */
	bool		(*f_ge) (const void *, const void *, fmLocalePtr, FmgrInfo *);	/* greater equal */
	bool		(*f_eq) (const void *, const void *, fmLocalePtr, FmgrInfo *);	/* equal */
	bool		(*f_le) (const void *, const void *, fmLocalePtr, FmgrInfo *);	/* less equal */
	bool		(*f_lt) (const void *, const void *, fmLocalePtr, FmgrInfo *);	/* less than */
	int32		(*f_cmp) (const void *, const void *, fmLocalePtr, FmgrInfo *); /* compare */
...
extern bool gbt_var_same(Datum d1, Datum d2, fmLocalePtr collation,
...
extern bool gbt_var_consistent(GBT_VARKEY_R *key, const void *query,
				   StrategyNumber strategy, fmLocalePtr collation, bool is_leaf,
				   const gbtree_vinfo *tinfo, FmgrInfo *flinfo);

extern GIST_SPLITVEC *gbt_var_picksplit(const GistEntryVector *entryvec, GIST_SPLITVEC *v,
				  fmLocalePtr collation, const gbtree_vinfo *tinfo, FmgrInfo *flinfo);

extern void gbt_var_bin_union(Datum *u, GBT_VARKEY *e, fmLocalePtr collation,
				  const gbtree_vinfo *tinfo, FmgrInfo *flinfo);
