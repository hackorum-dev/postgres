						...
						int *p_attrcnt)
{
	...
	/*
	 * For now, if the remote table is (or was once) inherited, fallback to
	 * sampling.
	 *
	 * XXX FIXME: for the case where it's inherited, we could support it by
	 * fetching and adding the relation stats for child tables as well.
	 */
