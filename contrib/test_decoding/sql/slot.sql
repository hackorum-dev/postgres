...
--
-- Test that a slot function that errors out still releases the slot, otherwise
-- the next slot operation in the session fails an assertion or leaks the slot.
--
